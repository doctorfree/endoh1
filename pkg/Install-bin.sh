...
usage() {
  echo "Usage: sudo ./Install-bin.sh /path/to/endoh1_<version>-<release>.<arch>.<suffix>"
  echo "Where:"
  ...
  echo "https://github.com/doctorfree/endoh1/releases"
  exit 1
}
...
[ "${pkgname}" == "endoh1" ] || {
  ...
  printf "\n\tendoh1_<version>-<release>.<arch>.<suffix>\n"
  echo "Distribution archive filename ${ARCHIVE} does not begin with 'endoh1'"
  usage
}
...
echo "available at https://github.com/doctorfree/endoh1/releases"
echo ""
while true
do
